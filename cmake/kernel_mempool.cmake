...
if (CONFIG_UT_KERNEL_MEM_POOL)

zephyr_library_named(kernel)

set(KERNEL_DIR ${ZEPHYR_BASE}/kernel)
...
#   target_sources(kernel PRIVATE ${KERNEL_DIR}/mempool.c)
...
target_link_libraries(kernel INTERFACE zephyr_interface)
